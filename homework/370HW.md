...
1. $66944$ bits
   ...
   Each block: 1’b Valid + 1’b Dirty + 20’b Tag + 32 \* 32’b Data = 1046bits. 

   cache: $32\times2\times1046=66944$ bits.  
...
2. AMAT = Hit time + Miss Rate \* Miss Penalty ? 
   $$
   \begin{align*}
   P_1:&\quad \text{Miss Penalty}=70ns/1.18ns = 59.3\text{ clock cycles} \\
   &\quad 1+4.3\%\times (70ns/1.18ns)= 3.55\text{ clock cycles}\\ 
   P_2:&\quad 1+2.7\%\times(70ns/2.22ns)=1.85\text{ clock cycles}
   \end{align*}
   $$
...
3. $$
   \begin{align*}
   P_1:&\quad CPI=1 + 36\%\times ((1-4.3\%)\times 1+4.3\%\times3.55) =1.40\text{ clock cycles} \\
   P_1:&\quad CPI=1 + 36\%\times ((1-2.7\%)\times 1+2.7\%\times1.85) =1.37\text{ clock cycles}\\
   \end{align*}
   $$
...
| ---- | ---- | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Y    | 0    | 1    | 0                                                            | (0, 1)                                                       |
| Y    | 0    | 0    | $10110\rightarrow 1011\rightarrow1 \rightarrow 10110 \rightarrow 11111$ | $(44,45)\rightarrow (22,23)\rightarrow(62, 63)\rightarrow (2,3) \rightarrow(44,45) \rightarrow (62,63)$ |
| Y    | 0    | 1    | 101                                                          | (10, 11)                                                     |
| Y    | 0    | 1    | 10111                                                        | (46, 47)                                                     |
...
| V    | D    | R    | Tag                     | Data                         |
| ---- | ---- | ---- | ----------------------- | ---------------------------- |
| Y    | 0    | 0    | $0\rightarrow1011$      | $(0,1)\rightarrow(22, 23)$   |
| Y    | 0    | 0    | $10110\rightarrow10111$ | $(44,45)\rightarrow (46,47)$ |
| Y    | 0    | 0    | $101\rightarrow 11111$  | $(10,11)\rightarrow(62,63)$  |
| Y    | 0    | 0    | $10111\rightarrow1$     | $(46,47)\rightarrow(2,3)$    |
