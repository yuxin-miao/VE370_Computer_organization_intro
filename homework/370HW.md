...
3. *In terms of miss rate:* **C3 is the best one**

   - C1: 1-word 8 blocks: all miss, miss rate = 1
   - C2: 2-word 4 blocks: one hit (**186**, **187**), miss rate = 1- 1/12 = 0.92
   - C3: 4-word 2 blocks: two hit (**4**,5,6,**7**) (184,185,**186**,**187**) miss rate = 1 - 2/12 = 0.83

   *In terms of time*: **C3 is the best one**

   - C1: stall time = 35 * 12 + 2 * 12 = 444
   - C2: stall time = 35 * 11 + 3 * 12 = 421
   - C3: stall time = 35 * 10 + 5 * 12 = 410
